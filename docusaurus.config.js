...
module.exports = {
  title: 'A modern financial advisor platform for the next generation.',
  tagline: 'If the world\s best financial advisor posted everything onto a single website.',
