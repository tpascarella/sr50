...
const FeatureList = [
  {
    title: 'Open Source',
    Svg: require('../../static/img/public_white_24dp.svg').default, 
  ...
  {
    title: 'Transparent',
    Svg: require('../../static/img/search_white_24dp.svg').default,
  ...
  {
    title: 'Secure',
    Svg: require('../../static/img/lock_white_24dp.svg').default,
